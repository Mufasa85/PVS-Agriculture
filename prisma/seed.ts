...
async function main() {
  ...
  const rawProducts = [
    // ── Œufs ──
    {
      name: "Œufs (plateau)",
      description:
        "Œufs frais vendus par plateau, issus de nos poules pondeuses.",
      category: "oeufs",
      priceAmount: 13000,
      currency: "FC",
      unit: "/ plateau",
    ...
    // ── Porc ──
    {
      name: "Porc",
      description:
        "Porc élevé dans des conditions d'hygiène strictes, chair de qualité.",
      category: "porc",
      priceAmount: 17000,
      currency: "FC",
      unit: "/ kg",
    ...
    },
    {
      name: "Ngolo",
      description:
        "Ngolo (poisson-chat local) élevé en étang, chair ferme et savoureuse.",
      category: "poissons",
      priceAmount: 10,
      currency: "USD",
      unit: "/ kg",
